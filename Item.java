...
public abstract class Item {
	...
	public static void main (String [] args) {
		...
		System.out.println("Readable: " + book1.getPrice() + " Book: " + book2.getPrice() + " eBook: " + book3.getPrice() );
		...
		System.out.println("Readable: " + book1.getQuantity() + " Book: " + book2.getQuantity() + " eBook: " + book3.getQuantity());
		System.out.println("Readable: " + book1.getAuthorName() + " Book: " + book2.getAuthorName() + " eBook: " + book3.getAuthorName());
		System.out.println(" Book:" + book2.getType() + " eBook:" + book3.getType());
		System.out.println("Readable:" + " " + book1.getBookName() + " Book: " + book2.getBookName() + " eBook: " + book3.getBookName());
	}
